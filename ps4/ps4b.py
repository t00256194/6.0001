...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        '''
        # Initialize variables for keeping track of the best shift and best decryption
        best_shift = 0
        best_decryption = ''
        max_real_words = 0
        ...
        for shift in range(26):
            ...
            real_words = sum([is_word(self.valid_words, word) for word in decrypted_text])

            # If the current shift creates more real words than any previous shift,
            # update the best shift and best decryption
            if real_words > max_real_words:
                max_real_words = real_words
                best_shift = shift
                best_decryption = self.apply_shift(shift)
